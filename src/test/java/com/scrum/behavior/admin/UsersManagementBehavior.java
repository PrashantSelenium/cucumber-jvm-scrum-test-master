...
public class UsersManagementBehavior extends BaseBehavior {
  ...
  public void administratorWantToAddNewUser() throws IOException {
    adminPerson.login();
    adminPerson.atAddUser().openAddUserPage();
  }

  @When("^Administrator add user with data$")
  public void administratorAddUserWithData(List<User> listUsers) throws IOException {
  ...
  public void administratorShouldSeeEditPageForCreatedUser() throws IOException {
